                    ...
                    <!--------------- logo ---------------------> 
                     ...
                     <div class="col-12">
                          <div class="card-heading">
                            <h2 class="title">Salary Report</h2>
                        </div>
                     </div>
                </div>
                        <div class="card-body">
                            <form id="salaryForm"  class="form-horizontal">
                              ...
                              <!---------------  Employee Email --------------------->  
                                <div class="col-lg-12">
                                        ...
                                        <input name="employee_email" id="employee_email" type="text" class="form-control" placeholder="Text.. " >
                                		</div>
                          			</div>
                                <!---------------  Class Name --------------------->  
                                <div class="col-lg-12">
